...
<title>Manhattan Blues</title>
</head>
<body>
<div class="container-fluid">
<nav class="navbar navbar-default" id="navcolor">
<div  class="navbar-header">
<a> <href=""class="navbar-brand"><img src='resources/images/Logo.png'height="60px" width="120px"></a>
...
<li><a href="<c:url value='/home'></c:url>"><span class="glyphicon glyphicon-t-shirt-v"></span> Home</a></li>
